      ...
      fs.exists(publicFilePath, function(exists) {
        ...
        fs.exists(path.resolve(publicFilePath + '.html'), function(exists) {
          ...
          fs.exists(apiFilePath, function(exists) {
            ...
            } else if (req.url === '/api/1/speakers') {
              return fapi.getData(req, res);
            } else if (req.url === '/api/1/attachments') {
              return fapi.getData(req, res);
            ...
            files: [
              {
                ...
                "spec": "original",
                "mime": "video/mp4",
                "url": !count3 ? "/test-video/playlist.m3u8" : "http://techslides.com/demos/sample-videos/small.mp4",
